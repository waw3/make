...
(function ($, oneApp, tinyMCEPreInit, tinyMCE, QTags, quicktags, wpActiveEditor, ttfOneMCE) {
	'use strict';
...
})(jQuery, oneApp, tinyMCEPreInit, tinyMCE, QTags, quicktags, wpActiveEditor, ttfOneMCE);