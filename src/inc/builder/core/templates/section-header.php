...
<div class="ttf-one-section <?php if ( isset( $ttf_one_section_data['data']['state'] ) && 'open' === $ttf_one_section_data['data']['state'] ) echo 'ttf-one-section-open'; ?> ttf-one-section-<?php echo esc_attr( $ttf_one_section_data['section']['id'] ); ?>" id="<?php echo esc_attr( $id ); ?>" data-iterator="<?php echo absint( ttf_one_get_builder_base()->get_iterator() ); ?>" data-section-type="<?php echo esc_attr( $ttf_one_section_data['section']['id'] ); ?>" data-iterator="<?php echo absint( ttf_one_get_builder_base()->get_iterator() ); ?>" data-section-type="<?php echo esc_attr( $ttf_one_section_data['section']['id'] ); ?>">
<?php endif; ?>
