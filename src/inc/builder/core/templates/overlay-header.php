<?php global $ttfmake_overlay_id, $ttfmake_overlay_class, $ttfmake_overaly_title; ?>
	...
	<div class="ttfmake-overlay-wrapper">
		<div class="ttfmake-overlay-header">
			<div class="ttfmake-overlay-window-head">
				<div class="ttfmake-overlay-title"><?php if ( ! empty( $ttfmake_overaly_title ) ) : echo $ttfmake_overaly_title; else : _e( 'Configuration', 'make' ); endif; ?></div>
