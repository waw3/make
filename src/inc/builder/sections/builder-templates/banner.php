...
<div class="ttf-one-slides">
	<div class="ttf-one-slides-stage">
		<?php foreach ( $section_order as $key => $section_id  ) : ?>
			<?php if ( isset( $ttf_one_section_data['data']['slides'][ $section_id ] ) ) : ?>
	...
	<input type="hidden" value="<?php echo esc_attr( implode( ',', $section_order ) ); ?>" name="<?php echo $section_name; ?>[slide-order]" class="ttf-one-slide-order" />
</div>
