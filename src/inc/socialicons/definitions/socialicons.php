...
$this->add_icons( array(
	...
	'google.com'         => array( 'title' => _x( 'Google', 'brand name', 'make' ), 'class' => array( 'fa', 'fa-fw', 'fa-google-plus-square' ) ),
	...
	'vimeo.com'          => array( 'title' => _x( 'Vimeo', 'brand name', 'make' ), 'class' => array( 'fa', 'fa-fw', 'fa-vimeo-square' ) ),
