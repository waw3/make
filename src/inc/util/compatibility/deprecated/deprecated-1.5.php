...
// Bail if this isn't being included inside of a MAKE_Util_Compatibility_CompatibilityInterface.
if ( ! isset( $this ) || ! $this instanceof MAKE_Util_Compatibility_CompatibilityInterface ) {
	return;
}
