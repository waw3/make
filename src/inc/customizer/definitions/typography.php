...
$this->add_section_definitions( 'font', array(
	...
	'controls' => array_merge(
		$this->get_typography_group_definitions( 'body', __( 'Default', 'make' ) ),
		array(
...
$this->add_section_definitions( 'font-headers', array(
	...
	'controls' => array_merge(
		$this->get_typography_group_definitions( 'h1', __( 'H1', 'make' ) ),
		$this->get_typography_group_definitions( 'h2', __( 'H2', 'make' ) ),
		$this->get_typography_group_definitions( 'h3', __( 'H3', 'make' ) ),
		$this->get_typography_group_definitions( 'h4', __( 'H4', 'make' ) ),
		$this->get_typography_group_definitions( 'h5', __( 'H5', 'make' ) ),
		$this->get_typography_group_definitions( 'h6', __( 'H6', 'make' ) )
	),
) );
...
$this->add_section_definitions( 'font-site-title-tagline', array(
	...
	'controls' => array_merge(
		$this->get_typography_group_definitions( 'site-title', __( 'Site Title', 'make' ) ),
		$this->get_typography_group_definitions( 'site-tagline', __( 'Tagline', 'make' ) )
	),
) );
...
$this->add_section_definitions( 'font-main-menu', array(
	...
	'controls' => array_merge(
		$this->get_typography_group_definitions( 'nav', __( 'Menu Items', 'make' ) ),
		$this->get_typography_group_definitions( 'subnav', __( 'Sub-Menu Items', 'make' ) ),
		array(
...
$this->add_section_definitions( 'font-header-bar', array(
	...
	'controls' => $this->get_typography_group_definitions(
		'header-bar-text',
...
$this->add_section_definitions( 'font-sidebar', array(
	...
	'controls' => array_merge(
		$this->get_typography_group_definitions( 'widget-title', __( 'Widget Title', 'make' ) ),
		$this->get_typography_group_definitions( 'widget', __( 'Widget Body', 'make' ) )
	),
) );
...
$this->add_section_definitions( 'font-footer', array(
	...
	'controls' => array_merge(
		$this->get_typography_group_definitions( 'footer-widget-title', __( 'Widget Title', 'make' ) ),
		$this->get_typography_group_definitions( 'footer-widget', __( 'Widget Body', 'make' ) ),
		$this->get_typography_group_definitions( 'footer-text', __( 'Footer Text', 'make' ) )
	),
) );
