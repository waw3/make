...
if ( ! function_exists( 'ttf_one_customizer_layout_blog' ) ) :
/**
 * Configure settings and controls for the Layout: Blog (Posts Page) section.
 *
 * @since  1.0.0.
 *
 ...
 * @return void
 */
function ttf_one_customizer_layout_blog( $wp_customize, $section ) {
