...
1. In the WordPress admin, click _Pages &rarr; Add New_.
...
The Page Builder's **Text** section generates a multi-column text layout.

1. Click the _Text_ section in the Page builder's section menu.
1. Choose the number of columns to use in the section by selecting an option from the *Columns* select input. You can display between 1-4 text columns in this section.
1. Set a section title by entering text in the text input with the _Enter title here_ placeholder text. The text section displays above the section. You are not required to enter a title.
1. Optionally wrap the featured image and column title in a link using the input with _Enter link here_ placeholder text.
1. Optionally add an image to the column by clicking the _Set featured image_ link or the clicking on the gray box with the image icon. In the modal window that pops up, click an existing image or drag and drop a new image onto the modal window. Click _Select_ to insert the image.
1. Optionally add a column title by entering text into the input with the _Enter title here_ placeholder text.
1. Optionally add content to the column in the WordPress editor input.
1. Repeat these steps for additional columns.
...
1. Click the _Blank_ section in the Page Builder's section menu.
...
1. Click the _Banner_ section in the Page Builder's section menu. When adding a new banner section, an initial slide is created for you.
